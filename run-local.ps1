...
Write-Host "`nNote: API and Orchestrator need PostgreSQL/Redis to run." -ForegroundColor Yellow
Write-Host "For full functionality, please install Docker and use deploy.ps1`n" -ForegroundColor Yellow
